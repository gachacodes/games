...
const promoCodes = [
    { 
        code: "GENSHINGIFT", 
        rewards: [
            { type: "image", value: "../images/games/genshin_impact/primogem.png", textKey: "x50" },
            { type: "image", value: "../images/games/genshin_impact/heros_wit.png", textKey: "x3" },
    ...
    { 
        code: "PFY1S40I88T9", 
        rewards: [
            { type: "image", value: "../images/games/genshin_impact/primogem.png", textKey: "x60" },
            { type: "image", value: "../images/games/genshin_impact/adventures_experience.png", textKey: "x5" }
        ],
        expires: 1786413600 
    },
    { 
        ...
        rewards: [
            { type: "image", value: "../images/games/genshin_impact/primogem.png", textKey: "x60" },
            { type: "image", value: "../images/games/genshin_impact/adventures_experience.png", textKey: "x5" },
            /*{ type: "image", value: "../images/games/genshin_impact/dynamik.png", textKey: "x10" }*/
        ],
        expires: 1786413600 
    },
    { 
        code: "EZSB8889C2BZ", 
        rewards: [
            { type: "image", value: "../images/games/genshin_impact/mora.png", textKey: "x10000" },
            { type: "image", value: "../images/games/genshin_impact/adventures_experience.png", textKey: "x10" },
            { type: "image", value: "../images/games/genshin_impact/fine_enhancement_ore.png", textKey: "x10" },
            { type: "image", value: "../images/games/genshin_impact/stir_fried_fish_noodles.png", textKey: "x10" },
            { type: "image", value: "../images/games/genshin_impact/jueyun_chilli_chicken.png", textKey: "x10" },
        ],
        expires: 1786413600 
    },
];
...
function renderCodes() {
    ...
    container.innerHTML = activeCodes.map(item => {
        ...
        return `
            <div class="${cardClass}">
                <div class="code-text" onclick="gotoLink(this)" value="https://genshin.hoyoverse.com/en/gift?code=${item.code}">
                    ${item.code}
                </div>
...
function gotoLink(element) {
    const targetUrl = element.value || element.getAttribute('value');
